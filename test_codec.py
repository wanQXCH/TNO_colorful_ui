...
w, h, bgra, meta = g.read_dds(r"D:\heart of iron\SW00383\langou123\hoi4\mod\2438003901\gfx\interface\leader_selection_entry_bg.dds")
...
w, h, bgra, meta = g.read_dds(r"D:\heart of iron\SW00383\langou123\hoi4\mod\2438003901\gfx\interface\flag_blank_41_26.dds")
...
# 3. 24-bit RGB decode: decision_image_IBR_congress (102x101)
w, h, bgra, meta = g.read_dds(r"D:\heart of iron\SW00383\langou123\hoi4\mod\2438003901\gfx\interface\decisions\decision_images\decision_image_IBR_congress.dds")
check("24-bit size", (w, h) == (102, 101) and len(bgra) == 102*101*4)
print("   IBR px sample:", tuple(bgra[0:4]), tuple(bgra[100:104]))

# 4. BGRA32 read
w, h, bgra, meta = g.read_dds(r"D:\heart of iron\SW00383\langou123\hoi4\mod\2438003901\gfx\interface\topbar\background.dds")
...
w, h, tga_px, hdr = g.read_tga(r"D:\heart of iron\SW00383\langou123\hoi4\mod\2438003901\gfx\interface\small_flag_overlay.tga")
...
# 8. DX10 BGRA read
w, h, bgra, meta = g.read_dds(r"D:\heart of iron\SW00383\langou123\hoi4\mod\2438003901\gfx\interface\focusview\shines\shine_diffuse.dds")
check("DX10 read", w > 0 and h > 0 and len(bgra) == w*h*4)
